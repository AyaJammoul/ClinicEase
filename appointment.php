...
$userLoggedIn = isset($_SESSION['patientname']) && isset($_SESSION['mobilenumber']);
...
<section class="appoinment section">
  <div class="container">
    ...
    <div class="form-group">
        ...
        <input type="text" id="patient-name" name="patientname" class="form-control" value="<?php echo htmlspecialchars($_SESSION['patientname']); ?>" readonly required>
    </div>
    <div class="form-group">
        <label for="patient-name">Mobile Number:</label>
        <input type="text" id="mobile-number" name="mobilenumber" class="form-control" value="<?php echo htmlspecialchars($_SESSION['mobilenumber']); ?>" readonly required>
    </div>
    ...
    <div class="form-group">
        <label>Vital Fill:</label><br>
        <input type="radio" id="vital-yes" name="vitalfill" value="Yes" required>
        <label for="vital-yes">Yes</label><br>
        <input type="radio" id="vital-no" name="vitalfill" value="No" required>
        <label for="vital-no">No</label>
    </div>
