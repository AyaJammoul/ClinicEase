...
<section class="section service-2">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-block mb-5 mb-lg-0">
					<img src="image/Cardiology.png" alt="" class="img-fluid">
					<div class="content">
						<h4 class="mt-4 mb-2 title-color">Cardiology</h4>
						<p class="mb-4">A cardiologist focuses on heart and blood vessel disorders. They manage conditions like heart disease, heart attacks, and high blood pressure.
							 Cardiologists aim to improve cardiovascular health.
						</p>
					</div>
				</div>
			</div>
