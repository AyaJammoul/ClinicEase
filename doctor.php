...
$sql = "SELECT doctorname, speciality FROM doctor where status = 'Active' "; 
...
<div class="row shuffle-wrapper portfolio-gallery">
    <?php foreach ($doctors as $doctor): ?>
        <div class="col-lg-3 col-sm-6 col-md-6 mb-4 shuffle-item" data-speciality="<?php echo htmlspecialchars($doctor['speciality']); ?>">
            <div class="position-relative doctor-inner-box">
                ...
                <div class="content mt-3">
                    <h4 class="mb-0"><?php echo htmlspecialchars($doctor['doctorname']); ?></h4>
