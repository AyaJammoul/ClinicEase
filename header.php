            ...
            <form id="edit-form" method="POST">
                ...
                <p>Marital Status: 
                    <select name="maritalstatus" class="editable" readonly disabled>
                        ...
                        <option value="Divorced" <?php echo ($fullUserDetails['maritalstatus'] == 'Divorced') ? 'selected' : ''; ?>>Divorced</option>
                        <option value="Widowed" <?php echo ($fullUserDetails['maritalstatus'] == 'Widowed') ? 'selected' : ''; ?>>Widowed</option>
                    </select>
                </p>
