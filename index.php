...
$doctorsCount = $conn->query("SELECT COUNT(*) as count FROM doctor WHERE status='Active'")->fetch_assoc()['count'];
$nursesCount = $conn->query("SELECT COUNT(*) as count FROM nurse WHERE status='Active'")->fetch_assoc()['count'];
